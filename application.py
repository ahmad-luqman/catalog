...
def gdisconnect():
    ...
    access_token = login_session['access_token'] if 'access_token' in login_session else login_session.get('credentials').access_token
    #access_token = credentials.access_token
...
def deleteItem(cat_name, item_name):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteItem.html', item = itemToDelete, cat_name = cat_name)
